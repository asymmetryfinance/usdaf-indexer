export const StabilityPoolAbi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "_B", type: "uint256" },
      {
        indexed: false,
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_topUp", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "uint256", name: "_boldYield", type: "uint256" }],
