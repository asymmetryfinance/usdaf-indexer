export const AfCvxImplAbi = [
  ...
  { inputs: [], name: "InvalidShare", type: "error" },
  ...
  },
  {
    ...
    name: "CleverCvxStrategyShareSet",
    type: "event",
  },
  {
    anonymous: false,
    ...
    inputs: [
      {
        indexed: true,
        internalType: "uint256",
        name: "cleverDepositAmount",
        type: "uint256",
      },
      {
        indexed: true,
        internalType: "uint256",
        name: "convexStakeAmount",
        type: "uint256",
      },
    ],
    name: "Distributed",
  ...
  },
  {
    ...
    name: "WeeklyWithdrawLimitUpdated",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    name: "cleverStrategy",
    outputs: [
      { internalType: "contract ICLeverStrategy", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_maxCleverDeposit", type: "uint256" },
      { internalType: "uint256", name: "_swapPercentage", type: "uint256" },
  ...
  },
  {
    ...
    name: "requestUnlock",
    outputs: [
      { internalType: "uint256", name: "_unlockEpoch", type: "uint256" },
  ...
  },
  {
    ...
    name: "setCleverCvxStrategyShare",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [],
    name: "withdrawalLimitNextUpdate",
